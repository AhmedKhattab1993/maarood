...
export function ViewAtBrand({
  ...
  const cls =
    variant === "detail"
      ? "inline-flex items-center justify-center gap-1 rounded-default bg-maaroud-blue px-6 py-3 text-sm font-semibold text-white transition-colors hover:bg-indigo"
      : "inline-flex flex-1 items-center justify-center gap-1 rounded-default bg-maaroud-blue px-3 py-2 text-sm font-semibold text-white hover:bg-indigo";
