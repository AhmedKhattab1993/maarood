  ...
  return (
    <form onSubmit={onSubmit} role="search" className="w-full max-w-xl">
      <input
        ...
        className="w-full rounded-default border border-cool-grey bg-white px-4 py-2 text-base text-ink-black outline-none transition focus:border-maaroud-blue"
      />
    </form>
  );
}
